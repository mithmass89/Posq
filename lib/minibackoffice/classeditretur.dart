...
import 'package:posq/minibackoffice/selecttransaksireceiving.dart';
...
class ClassEditReturn extends StatefulWidget {
  ...
  @override
  State<ClassEditReturn> createState() =>
      _ClassEditReturnState();
}

class _ClassEditReturnState
    extends State<ClassEditReturn> {
