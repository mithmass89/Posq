...
class ClassListDetailReceving extends StatefulWidget {
  ...
  const ClassListDetailReceving(
      {Key? key, this.trno, required this.pscd, required this.trtpcd})
      : super(key: key);

  @override
  State<ClassListDetailReceving> createState() => _ClassListDetailRecevingState();
}

class _ClassListDetailRecevingState extends State<ClassListDetailReceving> {
