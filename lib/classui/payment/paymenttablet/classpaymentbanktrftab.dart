...
class PaymentTrfTabs extends StatefulWidget {
  final String trno;
  final String pscd;
  final String trdt;
  final num balance;
  ...
  @override
  State<PaymentTrfTabs> createState() => _PaymentTrfTabsState();
}

class _PaymentTrfTabsState extends State<PaymentTrfTabs> {
