...
class CardDetailtabs extends StatefulWidget {
  final String keys;
  final Color color;
  ...
  @override
  State<CardDetailtabs> createState() => _CardDetailtabsState();
}

class _CardDetailtabsState extends State<CardDetailtabs> {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
        height: MediaQuery.of(context).size.height * 0.09 * widget.datax.length,
