...
class DetailMenuTerjualMobile extends StatefulWidget {
  ...
  @override
  State<DetailMenuTerjualMobile> createState() =>
      _DetailMenuTerjualMobileState();
}

class _DetailMenuTerjualMobileState extends State<DetailMenuTerjualMobile> {
