...
class DetailMenuTerjual2Mobile extends StatefulWidget {
  ...
  @override
  State<DetailMenuTerjual2Mobile> createState() =>
      _DetailMenuTerjual2MobileState();
}

class _DetailMenuTerjual2MobileState extends State<DetailMenuTerjual2Mobile> {
