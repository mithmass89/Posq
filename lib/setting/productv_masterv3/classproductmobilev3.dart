...
import 'package:posq/setting/productv_masterv3/classcreateproductmobilev3.dart';
import 'package:posq/setting/productv_masterv3/classeditproductv3.dart';
import 'package:posq/userinfo.dart';

ClassApi? apicloud;

class ClassproductmobileV3 extends StatefulWidget {
  const ClassproductmobileV3({Key? key, required this.pscd}) : super(key: key);
  final String pscd;
  @override
  State<ClassproductmobileV3> createState() => _ClassproductmobileV3State();
}

class _ClassproductmobileV3State extends State<ClassproductmobileV3> {
                              ...
                              child: TextButton(
                                  onPressed: () {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                          builder: (context) => Createproductv3(
                                                pscd: widget.pscd,
                                              )),
                                    ).then((_) {
                                      setState(() {});
