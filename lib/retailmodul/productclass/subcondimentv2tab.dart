...
class SubCondimentV2Tab extends StatefulWidget {
  final Item master;
  ...
  @override
  State<SubCondimentV2Tab> createState() => _SubCondimentV2TabState();
}

class _SubCondimentV2TabState extends State<SubCondimentV2Tab> {
  bool selected = false;
  String itemselected = '';
